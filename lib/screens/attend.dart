...
class AttendancePage extends StatefulWidget {
  ...
  AttendancePage({Key? key, this.collection, this.subcollection})
      : super(key: key);
  @override
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ChoiceChip(
                            label: Text('Present'),
                            selected: students[index].present == true,
                          ...
                          ChoiceChip(
                            showCheckmark: false,
                            avatar: students[index].present == false
                                ? Icon(Icons.close, color: Colors.black)
                                : null,
                            label: Text('Absent'),
                            selected: students[index].present == false,
                            onSelected: (bool selected) {
                              setState(() {
                                updatePresent1(
                                    widget.collection!,
